...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "frontend", "src", "data", "enr_projects_data.js")
...
def main():
    ...
    js += "export const ENR_PROJECTS_DATA = " + json.dumps(data, ensure_ascii=False, indent=2, default=str) + ";\n"

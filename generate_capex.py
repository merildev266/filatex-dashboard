...
js_parts = []
js_parts.append('/* === CAPEX JS — Auto-generated by generate_capex.py === */')
js_parts.append('export const capexData = {')
...
import os as _os
_out = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), 'frontend', 'src', 'data', 'capex_data.js')
_os.makedirs(_os.path.dirname(_out), exist_ok=True)
with open(_out, 'w', encoding='utf-8') as f:
    f.write(js)
print(f"[OK] Ecrit: {_out}")

...
function _renderInvCards(filtered) {
  ...
  filtered.forEach(function(p){
    ...
    var investVal = hasCx ? p.capex.invest : '—';
    var decaisseVal = hasCx ? p.capex.etat : '—';
    var execVal = hasCx ? p.capex.pct + '%' : '—';
    var pctWidth = hasCx ? p.capex.pct : 0;
    var pctBar = '<div style="width:100%;height:4px;background:rgba(243,112,86,0.1);border-radius:2px;margin-top:8px;"><div style="width:'+pctWidth+'%;height:100%;background:#f37056;border-radius:2px;"></div></div>';
    var cxHtml = '<div style="display:flex;justify-content:space-between;margin-top:8px;"><div><div style="font-size:9px;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:0.1em;">Invest</div><div style="font-size:16px;font-weight:800;color:#f37056;">'+investVal+'</div></div><div style="text-align:center;"><div style="font-size:9px;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:0.1em;">D\u00e9caiss\u00e9</div><div style="font-size:16px;font-weight:800;">'+decaisseVal+'</div></div><div style="text-align:right;"><div style="font-size:9px;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:0.1em;">Ex\u00e9cution</div><div style="font-size:16px;font-weight:800;color:#4ecdc4;">'+execVal+'</div></div></div>'+pctBar;

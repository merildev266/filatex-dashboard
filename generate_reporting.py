...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "frontend", "src", "data", "reporting_data.js")
...
def main():
    ...
    js = "/* Auto-generated by generate_reporting.py — DO NOT EDIT */\nexport const REPORTING_ENR = " + json.dumps(data, ensure_ascii=False, indent=2) + ";\n"

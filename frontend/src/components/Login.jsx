      ...
      <div className="fixed inset-0 z-[99999] bg-[#000] flex items-center justify-center overflow-hidden">
        ...
        <form onSubmit={handleSetPin} className="w-[88%] max-w-[400px] text-center relative z-10">
          ...
          <input
            ...
            style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', fontFamily: "'Aeonik', sans-serif" }}
          />
          <input
            type="password"
            inputMode="numeric"
          ...
          <button
            ...
            style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.1)', fontFamily: "'Aeonik', sans-serif", letterSpacing: '0.2em' }}
          >

...
function ReportingLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 55">
      <text fill="#ffffff" x="110" y="38" textAnchor="middle" fontFamily="'Aeonik',sans-serif" fontSize="30" fontWeight="700" letterSpacing="0.12em">REPORTING</text>
    </svg>
  )
}
...
function FinanceLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 55">
      <text fill="#ffffff" x="100" y="38" textAnchor="middle" fontFamily="'Aeonik',sans-serif" fontSize="32" fontWeight="700" letterSpacing="0.12em">FINANCE</text>
    </svg>
  )
}

...
function KpiCard({ label, value, sub, color }) {
  return (
    <div className="text-center p-5 rounded-2xl"
      style={{ background: 'var(--inner-card)', border: `1px solid rgba(94,76,159,0.15)` }}>
  ...
  return (
    <div style={{ maxWidth: 1240, margin: '0 auto' }}>
      ...
      <div className="text-center p-10 rounded-2xl mb-6"
        style={{ background: 'var(--subtle-bg)', border: '1px dashed rgba(94,76,159,0.15)', color: 'var(--text-dim)', fontSize: 13 }}>

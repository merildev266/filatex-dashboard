...
function ProjectDetailPanel({ project, onClose }) {
  ...
  return (
    <div style={{
      ...
      background: '#0a0916', zIndex: 100, overflowY: 'auto',
      ...
      <div style={{
        ...
        background: 'rgba(10,9,22,0.95)', backdropFilter: 'blur(12px)',
        borderBottom: '1px solid rgba(66,106,179,0.1)',
        display: 'flex', alignItems: 'center', gap: 16
      }}>
        <button
          onClick={onClose}
          style={{
            background: 'transparent', border: '1px solid rgba(66,106,179,0.3)',
            color: AZUR, padding: '4px 12px', borderRadius: 8, cursor: 'pointer',
            fontSize: 11, fontWeight: 700
          }}
        >
          &larr; Retour
        </button>
        <span style={{ fontSize: 16, fontWeight: 800, color: '#fff' }}>{project.name}</span>
      </div>

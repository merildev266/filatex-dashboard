...
function IconBolt() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="var(--text-dim)" strokeWidth="2" style={{ width: 24, height: 24 }}>
...
function IconMotor() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="var(--text-dim)" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
...
export default function ReportingOverview() {
  ...
  // ── Investments KPIs ──
  const invTotal = INV_PROJECTS?.length || 0
  const invExt = INV_PROJECTS?.filter(p => p.type === 'externe').length || 0
  const invInt = INV_PROJECTS?.filter(p => p.type === 'interne').length || 0

  // ── Properties KPIs ──
  const savProjects = groupByProject(PROPS_SAV || [])
  const savEtapes = (PROPS_SAV || []).length
  const savDelayed = (PROPS_SAV || []).filter(r => r.timing_var && r.timing_var.indexOf('Delay') >= 0).length

  const tvxProjects = groupByProject(PROPS_TVX || [])
  const tvxEtapes = (PROPS_TVX || []).length
  const tvxDelayed = (PROPS_TVX || []).filter(r => r.timing_var && r.timing_var.indexOf('Delay') >= 0).length

  const devProjects = groupByProject(PROPS_DEV || [])
  const devEtapes = (PROPS_DEV || []).length
  const devDelayed = (PROPS_DEV || []).filter(r => r.timing_var && r.timing_var.indexOf('Delay') >= 0).length

  const comVenteImmo = (COM_VENTE_IMMO_TOTAL / 1000000).toFixed(1) + 'M'
  const comVenteFonc = (COM_VENTE_FONCIERE_TOTAL / 1000000).toFixed(1) + 'M'
  const comLocation = (COM_LOCATION_TOTAL / 1000).toFixed(0) + 'k/m'
    ...
    <div className="rpt-poles-grid" style={{ alignItems: 'start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div className="rpt-hub-subgrid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>HFO</div>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>LFO</div>
        ...
        >
          ...
          <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>EnR</div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        >
          ...
          <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Ventures</div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div className="rpt-pole-card rpt-pole-card-sm rpt-pole-props" style={{ margin: 0, opacity: 0.4, pointerEvents: 'none' }}>
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Foncier</div>
            <div className="rpt-pole-sub" style={{ color: 'var(--text-dim)', fontSize: 10 }}>Bient&ocirc;t disponible</div>
          </div>
          <div className="rpt-pole-card rpt-pole-card-sm rpt-pole-props" style={{ margin: 0, opacity: 0.4, pointerEvents: 'none' }}>
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Suivis de permis</div>
            <div className="rpt-pole-sub" style={{ color: 'var(--text-dim)', fontSize: 10 }}>Bient&ocirc;t disponible</div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Dev</div>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Travaux</div>
            <div className="rpt-pole-sub" style={{ color: 'var(--text-muted)', fontSize: 10 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>Commercial</div>
          ...
          >
            ...
            <div className="rpt-pole-title" style={{ color: 'var(--text-dim)', fontSize: 13 }}>SAV</div>
            <div className="rpt-pole-sub" style={{ color: 'var(--text-muted)', fontSize: 10 }}>
